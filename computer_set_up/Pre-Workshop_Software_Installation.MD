...
3.	From your start menu(Do we mean start menu of Anaconda Navigator, or the overall start menu), go to Anaconda3(I directly searched for Anaconda Prompt as I couldn't find Anaconda3) and open the Anaconda Prompt
